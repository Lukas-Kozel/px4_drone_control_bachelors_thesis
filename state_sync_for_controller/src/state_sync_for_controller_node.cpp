...
{
public:
  typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::Imu,  geometry_msgs::msg::TwistStamped, sensor_msgs::msg::Imu> MySyncPolicy; //load_pose_stamped::msg::LoadPoseStamped, drone_pose_stamped::msg::DronePoseStamped, sensor_msgs::msg::Imu, angle_stamped_msg::msg::AngleStamped, geometry_msgs::msg::TwistStamped, sensor_msgs::msg::Imu
  StateSyncNode() : Node("state_sync_node")
  {
   ...
   custom_qos.best_effort();
    ...
    sync_ = std::make_shared<message_filters::Synchronizer<MySyncPolicy>>(MySyncPolicy(10), *load_imu_sub_,*drone_velocity_sub_, *drone_imu_sub_); // *load_pose_sub_, *drone_pose_sub_, *load_imu_sub_, *load_angle_sub_, *drone_velocity_sub_, *drone_imu_sub_
